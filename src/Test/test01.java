...
public class test01 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Monstre odin_t = new Cyclope("ODIN", "Titan");
...
//		ArrayList<Joueur> listeHeros = new ArrayList<Joueur>();
	    ...
	    if(choix == 1){
	        ...
	        voleur1 = new Voleur("Orkos", "Voleur");
	        voleur2 = new Voleur("Brok", "Voleur");
	        j1.listeHeros.add(mage1); j1.listeHeros.add(mage2); j1.listeHeros.add(guerrier1); j1.listeHeros.add(voleur1); j1.listeHeros.add(voleur2);
		    System.out.println("liste heros equipe choisie : " + j1.getListeHeros());
	    }
	    else if(choix == 3){
		    System.out.println("---- EQUIPE 3 ----");
	        ...
	        guerrier2 = new Guerrier("Atreus", "Guerrier");
	        voleur1 = new Voleur("Orkos", "Voleur");
	        j1.listeHeros.add(mage1); j1.listeHeros.add(mage2); j1.listeHeros.add(guerrier1); j1.listeHeros.add(guerrier1); j1.listeHeros.add(voleur1); 
		    System.out.println("liste heros equipe choisie : " + j1.getListeHeros());
	    }
	    else{
...
//	   j1.tourHeros(magni_b);
//	   j1.tourMonstre();
//	   j1.combat(zeus2, salle1_donjonInitiation);
	    
//	    System.out.println("liste des heros choisis");	    
//	  	j1.affichageHeros();
//	    j1.getListeHeros();
...
//	    mage.attaque(monstre1);
	    
	  //   if(g instanceof Heros && g instanceof Monstre) {
	 // 	((Heros)g).attaque(mo);
	//    }
...
//		Objet grossePotion = new Potion();
        ...
        fruitDuDemon = new Fruit("Fruit Du Demon", 100, 30);
        pommeAbandonee = new Fruit("Pomme Abandonee", 100, 10);
        petitePotion = new Potion("Petite Potion", 100, 10);
        grossePotion = new Potion("Grosse Potion", 100, 50);
		...
		j1.combat(odin_t, salle1_deuxiemeDonjon);
		j1.entreeSalle(deuxiemeDonjon, salle2_deuxiemeDonjon);
		j1.combat(ares_c, salle2_deuxiemeDonjon); 

	  	// Sortie du Donjon
	  	// Condition sur le reste des Ennemis dans les salles. Si un ennemi est mort, faire moins un au nombre d'ennemis. Condition d'affichage
	  	// sinon Sortie du Donjon et Retour au milieu 
		...
		//Personnage p1 = new Personnage("Ilias","Mage" ,"300");
	
		//caracteristiques.add("élément 1");

//	    public static void GameOver(Monstre monstre) {
//    	if(monstre.PV == 70) {
